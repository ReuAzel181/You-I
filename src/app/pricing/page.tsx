        ...
        <section className="bg-[var(--background)]">
          <div className="mx-auto max-w-6xl px-4 pb-12 md:px-8">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="flex flex-col rounded-2xl border border-emerald-500 bg-emerald-50 p-3 sm:p-4">
                  ...
                  <ul className="mt-4 space-y-1.5 text-[11px]">
                    <li className="flex items-start gap-2">
                      <span className="mt-0.5 inline-flex h-3.5 w-3.5 items-center justify-center rounded-full bg-emerald-500">
                        <svg
                          viewBox="0 0 16 16"
                          aria-hidden="true"
                        ...
                        >
                          <path
                            d="M6.5 11.5L3 8l1.1-1.1L6.5 9.3l5.4-5.4L13 5"
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="1.6"
                            strokeLinecap="round"
                ...
                <div className="flex flex-col rounded-2xl border-2 border-red-500 bg-red-50 pricing-featured-card p-5 sm:p-6 shadow-sm">
                  <div className="flex items-center justify-between gap-2">
              ...
              <div className="top-tier-glow w-full">
                <div className="violet-inner-ring flex h-full flex-col rounded-2xl border-2 border-violet-500 bg-gradient-to-b from-violet-50 to-violet-100 p-3 sm:p-4 shadow-sm">
                  <div className="flex items-center justify-between gap-2">
