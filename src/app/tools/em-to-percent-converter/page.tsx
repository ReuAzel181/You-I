...
export default function EmToPercentConverterPage() {
  ...
  useEffect(() => {
    ...
    trackEvent("view_em_to_percent_converter", { path: "/tools/em-to-percent-converter" });
  ...
  const handleBackClick = () => {
    ...
    window.setTimeout(() => {
      router.push("/?tool=em-to-percent-converter");
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="hero-intro space-y-4">
                ...
                <p className="max-w-2xl text-sm leading-relaxed text-zinc-600 sm:text-base">
                  Convert between px, rem, em, and percentages using an adjustable base font size.
                  Set your base once and see how values map across units.
                </p>
              </div>
              <button
                type="button"
