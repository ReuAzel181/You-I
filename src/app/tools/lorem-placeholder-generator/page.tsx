...
export default function LoremPlaceholderGeneratorPage() {
  ...
  useEffect(() => {
    ...
    trackEvent("view_lorem_placeholder_generator", {
      path: "/tools/lorem-placeholder-generator",
    });
  ...
  const handleBackClick = () => {
    ...
    window.setTimeout(() => {
      router.push("/?tool=lorem-placeholder-generator");
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="hero-intro space-y-4">
                ...
                <p className="max-w-2xl text-sm leading-relaxed text-zinc-600 sm:text-base">
                  Create lorem ipsum placeholders with adjustable length and casing. Quickly copy
                  words or paragraphs formatted to match your interface.
                </p>
              </div>
              <button
                type="button"
